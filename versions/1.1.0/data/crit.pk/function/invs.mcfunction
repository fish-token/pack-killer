...
item replace entity @a player.crafting.0 with air
item replace entity @a player.crafting.1 with air
item replace entity @a player.crafting.2 with air
item replace entity @a player.crafting.3 with air